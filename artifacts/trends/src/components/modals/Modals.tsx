...
function ShopMockup() {
  ...
  return (
    <div className="mt-2 mb-0 flex flex-col gap-[7px] overflow-hidden -mx-6">
      {/* Row 1 — scrolls left */}
      <motion.div
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col h-full px-6 pt-6 pb-8">
        ...
        <div className="flex-1 flex flex-col justify-start pt-14 min-h-0">
          <AnimatePresence mode="wait" custom={direction}>
            ...
            >
              ...
              {slide === 2 && (
                <p className="text-white/70 text-[19px] leading-snug text-center px-2 mt-3 mb-4" style={{ fontWeight: 300, letterSpacing: '0.01em', whiteSpace: 'pre-line' }}>
        ...
        <div className="flex items-center justify-center gap-1.5 mb-4 mt-8">
